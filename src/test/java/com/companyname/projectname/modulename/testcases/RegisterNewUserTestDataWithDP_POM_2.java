...
public class RegisterNewUserTestDataWithDP_POM_2 extends TestBase { // Business logic
	...
	public void registerNewUserTestDataWithDP_POM_2(Hashtable<String, String> ht) {
