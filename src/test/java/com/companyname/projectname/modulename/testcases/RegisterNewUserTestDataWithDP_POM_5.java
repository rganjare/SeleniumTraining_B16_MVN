...
public class RegisterNewUserTestDataWithDP_POM_5 extends TestBase { // Business logic
	...
	public void registerNewUserTestDataWithDP_POM_5(Hashtable<String, String> ht) {
		...
		System.out.println("Test case created by Sunil");
