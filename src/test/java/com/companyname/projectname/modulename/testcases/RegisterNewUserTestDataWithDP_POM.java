...
public class RegisterNewUserTestDataWithDP_POM extends TestBase { // Business logic
	...
	public void registerNewUserTestDataWithDP_POM(Hashtable<String, String> ht) {
