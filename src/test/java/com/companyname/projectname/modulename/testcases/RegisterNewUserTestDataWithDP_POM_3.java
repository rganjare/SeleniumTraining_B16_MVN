...
public class RegisterNewUserTestDataWithDP_POM_3 extends TestBase { // Business logic
	...
	public void registerNewUserTestDataWithDP_POM_3(Hashtable<String, String> ht) {
